...
downstream (`docs/archive/collaborative-slam.md`) is unchanged and unaware of the
difference.
...
(`docs/archive/collaborative-slam.md` §2.2: known-free contradiction is what breaks
...
# `docs/archive/collaborative-slam.md` §2.2 keys grid matching on known-free
