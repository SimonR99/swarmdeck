...
def test_unchanged_scan_reuses_cloud_and_planar_ranges_when_pose_advances(rig, monkeypatch):
    node, robot = rig
    calls = {"cloud": 0, "slice": 0, "prox": 0, "nav": 0}
    ...
    assert calls == {"cloud": 1, "slice": 1, "prox": 1, "nav": 2}
