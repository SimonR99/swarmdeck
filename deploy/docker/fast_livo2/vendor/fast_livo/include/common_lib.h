...
enum LID_TYPE
{
  ...
  XT32 = 5,
  PANDAR128 = 6,
  // PointCloud2 in the Livox layout (x,y,z,intensity,timestamp,tag,line).
  // This is what livox_ros_driver2 publishes when not using CustomMsg, and
  // what the ARGoS simulation emits.
  LIVOX_PCL2 = 7
};
enum SLAM_MODE
{
